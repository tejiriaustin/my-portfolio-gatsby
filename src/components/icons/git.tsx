...
export const GitIcon = (): Icon => {
  return (
    ...
    >
      <rect width="50" height="51" fill="url(#pattern19)" />
      <defs>
        <pattern
          id="pattern19"
        ...
        >
          <use
            xlinkHref="#image0_160_3"
            transform="matrix(0.0051 0 0 0.005 -0.01 0)"
          />
        </pattern>
        <image
          id="image0_160_3"
